...
#define STRING_CONFIG_H_AUTHOR "(Domenick Petrella, domenick.petrella@gmail.com)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // T MAX 2.0 24V Heater Cartridge (same 24V cartridge used in both J-Head and E3D)
  #define DEFAULT_Kp 24.17
  #define DEFAULT_Ki 4.61
  #define DEFAULT_Kd 31.68
  // Ultimaker
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 3200.000, 725.0 }
